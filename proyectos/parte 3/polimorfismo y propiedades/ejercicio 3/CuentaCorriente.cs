...
namespace ejercicio3
{
    class CuentaCorriente : Cuenta
    {
        ...
        public CuentaCorriente(string numero, string titular, int maximoTransacciones, double recargoXTransaccionAdicional_Euros) : base(numero, titular)
        {
            this.maximoTrasaccionesGratuitasPorMes = maximoTransacciones;
            this.recargoXTransaccionAdicional_Euros = recargoXTransaccionAdicional_Euros;
            reiniciaTransacciones();
        }
        ...
        public void AplicaRecargosMes()
        {
            ...
            {
                Saldo -= (numeroTrasaccionesMesActual - maximoTrasaccionesGratuitasPorMes) * recargoXTransaccionAdicional_Euros;
            }  
            reiniciaTransacciones();
        }
