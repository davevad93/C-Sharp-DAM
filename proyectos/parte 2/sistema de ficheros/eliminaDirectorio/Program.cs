...
// 3. Comando eliminaDirectorio: Se le pasa una ruta y te elimina un directorio, tendrás que
// controlar si se indica más de una entrada o capturar las excepciones de ruta inválida.

namespace eliminaDirectorio
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                {
                    Console.WriteLine("\nSe puede eliminar sólo 1 directorio dentro de una ruta válida.\n");
                }                                 
            }
